...
export function LoginVariantA() {
  ...
  return (
    <>
      {/* Override do autofill do browser para manter fundo escuro */}
      <style>{`
            ...
            {!isLogin && (
              <div className="field mb-3.5">
                ...
                <div className="input flex items-center gap-2.5 bg-[var(--bg-2)] border border-[var(--line-2)] rounded-xl px-3.5 h-[46px] transition-all focus-within:border-[var(--v-500)] focus-within:shadow-ring-v">
                  ...
                  <input type="text" name="companyName" placeholder="Ex: TechCorp" required className="flex-1 text-[14px] text-[var(--fg-0)] h-full bg-transparent border-0 outline-none placeholder:text-[var(--fg-3)]" />
                </div>
              </div>
            )}

            {/* Campo Email — sem defaultValue mockado */}
            <div className="field mb-3.5">
              ...
              <div className="input flex items-center gap-2.5 bg-[var(--bg-2)] border border-[var(--line-2)] rounded-xl px-3.5 h-[46px] transition-all focus-within:border-[var(--v-500)] focus-within:shadow-ring-v">
                ...
                <input
                  ...
                  required
                  autoComplete="email"
                  className="flex-1 text-[14px] text-[var(--fg-0)] h-full bg-transparent border-0 outline-none placeholder:text-[var(--fg-3)]"
                />
              </div>
            </div>

            {/* Campo Senha — sem defaultValue mockado + toggle funcional */}
            <div className="field mb-3.5">
              ...
              <div className="input flex items-center gap-2.5 bg-[var(--bg-2)] border border-[var(--line-2)] rounded-xl px-3.5 h-[46px] transition-all focus-within:border-[var(--v-500)] focus-within:shadow-ring-v">
                ...
                <button
                  ...
                  className="tool-btn w-8 h-8 rounded-lg grid place-items-center text-[var(--fg-2)] hover:bg-[var(--bg-3)] hover:text-[var(--fg-1)] shrink-0 transition-colors"
                >
